<%@ Page Title="" Language="C#" Inherits="System.Web.Mvc.ViewPage<ioschoolsWebsite.Models.exam.templates.TemplateListViewModel>" MasterPageFile="~/Views/Shared/Internal.Master" %>
<asp:Content runat="server" ID="Title" ContentPlaceHolderID="TitleContent">Exam Templates</asp:Content>
...
<% Html.RenderPartial("Content", Model.templates);%>
</div>
</div>
</div>

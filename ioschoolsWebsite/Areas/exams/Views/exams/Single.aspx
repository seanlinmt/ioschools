<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Internal.Master" Inherits="System.Web.Mvc.ViewPage<ioschoolsWebsite.Models.exam.viewmodels.ExamViewModel>" %>
        ...
        <div id="subjects" class="hidden pt10">
            ...
            <div class="form_entry">
                <div class="form_label">
                    ...
                    <div class="tip">
                        Assign a School Subject to the Exam Subject to limit editing of exam results to ONLY assigned subject teachers.</div>
                </div>

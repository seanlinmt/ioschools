<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Internal.Master" Inherits="System.Web.Mvc.ViewPage<ioschoolsWebsite.Models.finance.FinanceViewModel>" %>
...
<div id="search_area" class="relative">
    ...
    <div class="clear"></div>
        ...
        <% Html.RenderPartial("alerts", Model.alerts); %>
    </div>
    <div id="update" class="hidden">
        <% Html.RenderPartial("update", Model.schoolList); %>
    </div>
    <div id="fees" class="hidden">
        <% Html.RenderPartial("fees", Model.schoolList); %>
    </div>
    <div id="groups" class="hidden">
        <% Html.RenderPartial("groups", Model.schoolList); %>
    </div>
    <div id="templates" class="hidden">
        <% Html.RenderPartial("templates", Model.templates); %>
    </div>
    <div id="messaging" class="hidden">
            <% Html.RenderPartial("messaging", Model.schoolList);%>

        </div>
        <div id="statistics" class="hidden">
        <% Html.RenderPartial("statistics", Model.schoolList);%>

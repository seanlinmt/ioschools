<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Internal.Master" Inherits="System.Web.Mvc.ViewPage<ioschoolsWebsite.Models.leave.LeaveViewModel>" %>
...
<div class="main_columnright">
  ...
  <tr><td><%= entry.name %></td><td><%= entry.annualTotal %></td><td><%= entry.remaining%></td><td><%= entry.taken %></td></tr>
    ...
    <table id="leaveTable" class="table_grey mb20">
        ...
        <tbody>
            <% Html.RenderPartial("IndexRows", Model.takenleaves); %>
        </tbody>
    </table>

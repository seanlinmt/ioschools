<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Main.Master" Inherits="System.Web.Mvc.ViewPage<ioschoolsWebsite.Models.calendar.CalendarViewModel>" %>
...
<script src="../../Scripts/jquery.scrollTo-min.js" type="text/javascript"></script>
    <div class="body_content">
        <div class="breadcrumb">
            ...
            <h3><%= ioschoolsWebsite.Models.calendar.Calendar.months[pair.First - 1] %> <%= pair.Second %><a class="scroll_top" href="">back to top</a></h3>
            <table id="<%= pair.First %>_<%= pair.Second %>">

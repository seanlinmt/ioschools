<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Internal.Master" Inherits="System.Web.Mvc.ViewPage<ioschoolsWebsite.Models.calendar.admin.CalendarAdminViewModel>" %>
...
<% Html.RenderPartial("calendarContent", Model.entries);%>
</tbody>
</table>
</div>
</div>

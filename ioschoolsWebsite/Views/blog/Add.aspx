<%@ Page Title="" Language="C#" Inherits="System.Web.Mvc.ViewPage<ioschoolsWebsite.Models.blog.BlogViewData>" MasterPageFile="~/Views/Shared/Internal.Master" %>
<%@ Import Namespace="ioschools.Data.CMS" %>
<%@ Import Namespace="ioschoolsWebsite.Library.Helpers" %>
<asp:Content runat="server" ID="Content1" ContentPlaceHolderID="TitleContent">Circulars / News</asp:Content>

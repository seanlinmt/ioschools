<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<ioschoolsWebsite.Models.school.AdminSchoolTermsViewModel>" %>
...
<div class="main_columnright pb50">
 ...
 <% Html.RenderPartial("TermsContent", Model.terms); %>
  </form>
  <div class="mt10">

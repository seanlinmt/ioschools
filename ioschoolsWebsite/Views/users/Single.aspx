<%@ Page Title="" Language="C#" Inherits="System.Web.Mvc.ViewPage<ioschoolsWebsite.Models.user.UserViewModel>"
    MasterPageFile="~/Views/Shared/Internal.Master" %>

<%@ Import Namespace="ioschools.Data.User" %>
<asp:Content runat="server" ID="Title" ContentPlaceHolderID="TitleContent">
    <%= Model.usr.name %></asp:Content>
...
<% if (Model.usr.usergroup == UserGroup.STUDENT && Model.userauth.perms.HasFlag(Permission.TRANSCRIPTS_CREATE)){%>
   ...
   { %>
    ...
    <% Html.RenderPartial("~/Views/Users/SingleContent.ascx",Model.usr); %>

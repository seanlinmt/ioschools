<%@ Page Title="" Language="C#" Inherits="System.Web.Mvc.ViewPage<ioschoolsWebsite.Models.homework.viewmodels.HomeworkViewModel>" MasterPageFile="~/Views/Shared/Internal.Master" %>
<%@ Import Namespace="ioschoolsWebsite.Library.Helpers" %>
<asp:Content runat="server" ID="Title" ContentPlaceHolderID="TitleContent">Homework</asp:Content>
...
<div class="main_columnright">
    ...
    <table id="homeworkTable" class="table_grey">
        ...
        <tbody>
            <% Html.RenderPartial("TeacherRows", Model.homeworks); %>
        </tbody>
    </table>

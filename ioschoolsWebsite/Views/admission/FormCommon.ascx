...
<tbody>
<% Html.RenderPartial("~/Views/admission/siblings.ascx"); %>
</tbody>
<tfoot>
...
<% Html.RenderPartial("~/Views/admission/FormParents.ascx", Model);%>
<% Html.RenderPartial("~/Views/admission/FormGuardian.ascx", Model);%>
</div>

<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<ioschoolsWebsite.Models.fees.viewmodel.SchoolFeeStudentViewModel>" %>
<div class="mt10">
  ...
  <td class="w175px"></td>
    ...
    <tbody id="fee_results_<%= Model.studentid %>">
        ...
        <%}
           ...
           {
               Html.RenderPartial("StudentRows", Model.fees);
           }%>
    </tbody>
</table>
